...
const confirmadorTourSteps: DemoTourStep[] = [
  ...
  },
  {
    id: 'confirm-flow',
    title: 'Confirmar Pedido',
    description: 'Haz clic en un pedido pendiente, revisa los datos del cliente, y confirma con el botón verde.',
    route: '/orders',
    target: '[data-tour-target="orders-table"]',
    placement: 'top',
    action: 'observe',
  },
  {
    ...
    description: 'Al confirmar, puedes enviar un mensaje automático al cliente con los detalles del pedido.',
    route: '/orders',
    target: '[data-tour-target="new-order-button"]',
    placement: 'bottom',
    action: 'observe',
  },
  {

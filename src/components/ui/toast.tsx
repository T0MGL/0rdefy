...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      // Mobile: bottom-anchored above bottom nav (h-16 + safe-area), full width with padding
      // Desktop (sm+): bottom-right corner stack
      "fixed bottom-[calc(env(safe-area-inset-bottom)+5rem)] left-0 right-0 z-[100] flex max-h-screen w-full flex-col p-4 sm:bottom-0 sm:right-0 sm:left-auto sm:top-auto sm:flex-col md:max-w-[420px]",
      className,
    )}
    {...props}
  />

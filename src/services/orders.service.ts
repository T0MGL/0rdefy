  ...
  confirm: async (id: string, storeId: string): Promise<Order | undefined> => {
    try {
      ...
      return {
        ...
        inPreparationTimestamp: data.in_preparation_at,
        readyToShipTimestamp: data.ready_to_ship_at,
        inTransitTimestamp: data.in_transit_at,
        outForDeliveryTimestamp: data.out_for_delivery_at,
        deliveredTimestamp: data.delivered_at,
        cancelledTimestamp: data.cancelled_at,
        rejectedTimestamp: data.rejected_at,
        returnedTimestamp: data.returned_at,
        incidentTimestamp: data.incident_reported_at,

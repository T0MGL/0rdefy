...
-- ================================================================
-- PART 3.5: Order Line Items (Normalized Product Mapping)
-- ================================================================
-- Purpose: Normalized table for order line items with proper mapping
--          to local products (replaces JSONB parsing)
-- ================================================================
...
-- ================================================================
-- FUNCIONES PARA ORDER LINE ITEMS (Shopify Product Mapping)
-- ================================================================

-- Helper function to find product by Shopify IDs (variant > product > SKU)
...
-- Function to parse line items from Shopify order and create normalized records
...
-- Trigger de order_line_items updated_at
DROP TRIGGER IF EXISTS trigger_update_order_line_items_updated_at ON order_line_items;
CREATE TRIGGER trigger_update_order_line_items_updated_at BEFORE UPDATE ON order_line_items FOR EACH ROW EXECUTE FUNCTION update_order_line_items_updated_at();

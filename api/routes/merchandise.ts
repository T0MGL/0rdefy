...
// Apply plan feature check - merchandise requires Starter+ plan
merchandiseRouter.use(requireFeature('merchandise'));
...
// ================================================================
merchandiseRouter.post('/', requirePermission(Module.MERCHANDISE, Permission.CREATE), async (req: PermissionRequest, res: Response) => {
  try {
    const {
      supplier_id,
      carrier_id,

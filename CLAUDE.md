...
- 124: **NEW:** Fix customers.city length (increased from VARCHAR(100) to VARCHAR(150) to match system-wide standard and handle long city names from external webhooks - prevents 500 errors on customer creation)
